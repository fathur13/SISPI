<x-module.sispi-koordinator>
    <div class="container-fluid">
        ...
        <div>
            <h4 class="h6 mb-0 text-gray-900" style="font-size: 40px; font-family:'Times New Roman', Times, serif">
                Koordinator
        ...
        <div class="row" style="margin-top: 7%">
            ...
            <div class="col-xl-3 col-md-6 mb-4">
                <a href="{{ url('sispi/koordinator/pengajuan-surat') }}">
                    <div class="card border-left-warning shadow h-100 py-2">
                        <div class="card-body">
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    <div class="h5 font-weight-bold text-warning text-uppercase mb-1">Surat Ditolak
                                    </div>
                                    <div class="h3 mb-0 font-weight-bold text-gray-800">{{ $ditolak }}
                                    </div>
                                </div>
                                <div class="col-auto">
                                    <i class="fas fa-clipboard-list fa-2x text-gray-300"></i>
