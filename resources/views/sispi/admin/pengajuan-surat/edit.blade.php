<x-module.sispi-admin>
    <div class="container-fluid">
        <x-template.button.back-button url="sispi/admin/pengajuan-surat" />
        <div class="card shadow mb-4">
            <div class="card-header bg-secondary">
                <h5 class="h2 m-0 font-weight-bold text-white">Edit Surat Keluar</h5>
            </div>
            <div class="card-body">
                <form action="{{ url('sispi/admin/pengajuan-surat', $suratkeluar->id) }}" id="add_form"
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control " name="status">
                                    <option value="1">Sudah Di edit</option>
                                </select>
                            </div>
                        </div>
                    </div> --}}
