<x-module.admin>
    <div class="container-fluid">
        ...
        <div>
            <h4 class="h6 mb-0 text-gray-900" style="font-size: 40px; font-family:'Times New Roman', Times, serif">Super
                Admin SISPI LORD {{ auth()->user()->nama }} </h4>
        </div>
        ...
        <div class="row" style="margin-top: 5%">
            ...
            <div class="col-xl-3 col-md-6 mb-4">
                <a href="{{ url('sispi/admin/kelengkapan') }}">
                            ...
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    <div class="h5 font-weight-bold text-warning text-uppercase mb-1">
                                        Lapor Keluhan</div>
                                    <div class="h3 mb-0 font-weight-bold text-gray-800">{{ $jumlah_keluhan }}
                                    </div>
                                </div>
                                <div class="col-auto">
                                    <i class="fas fa-clipboard-list fa-2x text-gray-300"></i>
